...
df_SSDSE_E[target_columns_E].to_sql(name='population', con='sqlite:///data/SSDSE.db', if_exists='replace', index=False)
...
df_SSDSE_E_2021.sort_values(
    ...
    name='elderly_population_top10', con='sqlite:///data/SSDSE.db', if_exists='replace', index=False)

df_SSDSE_E_2021.sort_values(
    '大学学生数', ascending=False)[:10][['地域コード', '都道府県', '総人口']].to_sql(
    name='university_student_population_top10', con='sqlite:///data/SSDSE.db', if_exists='replace', index=False)
